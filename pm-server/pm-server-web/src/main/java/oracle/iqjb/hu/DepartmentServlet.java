...
public class DepartmentServlet extends HttpServlet {
    ...
    @EJB
    private DepartmentSessionService departmentSessionServiceBean;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            departmentSessionServiceBean.addDepartment(new AddDepartmentRequest("foobar"));
            departmentRepository1.findAll().forEach(
                    d -> out.println(d.toString())
            );
            out.println("</body>");
            out.println("</html>");
        }
